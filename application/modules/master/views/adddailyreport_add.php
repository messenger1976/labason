<main id="js-page-content" role="main" class="page-content">
	<ol class="breadcrumb page-breadcrumb">
		...
		<li class="breadcrumb-item"><a href="<?php echo ADMIN_URL;?>adddailyreport/">Daily Report Bills</a></li>
	...
	<div class="subheader">
		<h1 class="subheader-title">
			...
			Manage <span class="fw-300">Adddailyreport Add</span>
		</h1>
	</div>
	...
	<div class="row">
		<div class="col-xl-12">
			<div class="panel">
				<div class="panel-hdr">
					<h2>Adddailyreport Add <span class="fw-300"><i>Details</i></span></h2>
...
$(document).ready(function(){
	...
	$('#printtopdf').on('click',function(evt){
		...
		const popup = window.open(
			"adddailyreport/printtopdf/"+fromdate+'/'+zone+'/'+preparedby+'/'+verifiedby+'/'+approvedby+'/'+grouping+'/'+cashier, // URL to display 
