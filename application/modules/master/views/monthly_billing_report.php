<main id="js-page-content" role="main" class="page-content">
	<ol class="breadcrumb page-breadcrumb">
		...
		<li class="breadcrumb-item"><a href="<?php echo ADMIN_URL;?>reports/monthly_billing_report">Monthly Billing Reports</a></li>
	...
	<div class="row">
		<div class="col-xl-12">
			<div class="panel">
				<div class="panel-hdr">
					<h2>Monthly Billing Report <span class="fw-300"><i>Details</i></span></h2>
