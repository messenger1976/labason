<?php
	...
	$sa4_page_subtitle = 'Classification';
	$sa4_loading_label = 'Classification';
	$sa4_dt_entity = 'classification';
	$sa4_panel_id = 'panel-classification';
?>
<main id="js-page-content" role="main" class="page-content">
	<ol class="breadcrumb page-breadcrumb">
		<li class="breadcrumb-item"><a href="<?php echo ADMIN_URL;?>dashboard">Home</a></li>
		<li class="breadcrumb-item"><a href="<?php echo ADMIN_URL;?>classification/add">Add Classification</a></li>
								...
								<table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
												...
												<tbody>
												  <?php
													...
													?>   
													<tr>
														<td><input type="checkbox" class="checkbox" name="delete_ids[]" id="delete_ids[]" value="<?php echo $row['class_id'];?>" /></td>
														<td><?php echo $i; ?></td>
