<main id="js-page-content" role="main" class="page-content">
	...
	<div class="subheader">
		<h1 class="subheader-title">
			...
			Manage <span class="fw-300">Classification Category Add</span>
		</h1>
	</div>
	...
	<div class="row">
		<div class="col-xl-12">
			<div class="panel">
				<div class="panel-hdr">
					<h2>Classification Category Add <span class="fw-300"><i>Details</i></span></h2>
					...
					<div class="row">
						...
						<div class="col-sm-6 col-lg-12">
							...
							<form class="form-horizontal" role="form" name="myform" id="myform" method="post" action="" enctype="multipart/form-data">
										...
										<fieldset>
													<h5 class="mb-3">Classification Category-Add </h5>
