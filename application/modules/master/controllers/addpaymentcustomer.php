		...
		try {
			...
			foreach($records as $row) {
				...
				$action_html = '<input type="hidden" name="customerid_'.$i.'" id="customerid_'.$i.'" value="'.(isset($row['customer_id']) ? $row['customer_id'] : '').'">
								...
								<a href="#" title="Secondary Print">
									<i class="print_button_new2 fa fa-print" id="print_button_new2'.$i.'" data-print-val-id="'.$i.'" style="color: #5bc0de;"></i>
								</a>&nbsp;&nbsp;&nbsp;
...
<body>
    ...
    <div class="receipt-column">
       ...
       <table class="item-table">
                    ...
                    <td style="width: 50%;text-align: right;">$amount</td>                 
                    
                    <td style="text-align: right;">$pay_amount</td>
                </tr>
                <tr>
                    <td style="width: 50%;text-align: right;">$arrears</td>
				...
				<tr>
                    <td style="width: 50%;text-align: right;">$sc_discount</td>
                    
                    
                    <td style="text-align: right;"></td>
                </tr>
				<tr>
                    <td style="width: 50%;text-align: right;">$grand_total</td>
